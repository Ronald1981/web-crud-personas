...
<body>
    ...
    ?>
        <th>
            ...
            <h3>Desarrolado por Univ. Delfin R. Gareca C.  &  Univ. Veronica Toledo R.</h3>
        ...
        <form action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
            ...
            <td><input id="M" type="radio" name="Sexo" value="M"> <label for="sexo">M</label>
            <input id="F" type="radio" name="Sexo" value="F"> <label for="sexo">F</label> <br></td>
